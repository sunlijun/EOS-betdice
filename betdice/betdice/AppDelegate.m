...
- (void)applicationDidFinishLaunching:(NSNotification *)aNotification {
    ...
    // 设置NSStatusItem 的图片
    NSImage *image = [NSImage imageNamed:@"sbicon"];
    ...
    BDStatusBarViewController *vc = [[BDStatusBarViewController alloc]initWithNibName:@"BDStatusBarViewController" bundle:nil];
